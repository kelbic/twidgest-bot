...
<div class="price-note">картой или через СБП — либо 999 ⭐ внутри Telegram</div>
<ul>
...
<p class="pay-note">
Оплата — в пару кликов внутри Telegram: российской картой или через СБП,
либо звёздами Telegram. Продление добавляет 30 дней к текущей дате
...
<p>
Канал — 1490 ₽ за 30 дней. Платить можно российской картой или через СБП
(в <code>/upgrade</code> кнопка «💳 1490 ₽»), либо звёздами Telegram — 999 ⭐
за тот же период. Оба способа работают внутри Telegram, счёт приходит в чат.
</p>
</details>
