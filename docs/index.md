...
текстовых постов, медиана лайков, сколько твитов прошло бы пороги именно
твоего канала. Добавление — только по твоей кнопке, бот сам источники
не меняет.
</p>
</div>
...
Essayist бесплатен в раннем доступе (бета). Напиши <a href="https://t.me/kelbic">@kelbic</a>,
